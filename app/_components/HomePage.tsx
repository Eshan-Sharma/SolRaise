      ...
      <main className="container mx-auto p-4">
        ...
        <section className="py-20 text-center">
          <h2 className="text-6xl font-bold mb-4 ">
            Empower Change with Solana
          </h2>
          <p className="text-xl mb-8">
            Fund innovative projects or create your own campaign on our
        ...
        <section className="mb-20">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {projects.map((project) => (
              <Card
                key={project.id}
                className="bg-gray-800 border border-gray-700 hover:bg-gray-700 transition-colors"
              >
                <CardHeader>
        ...
        <section id="stats" className="py-20 border-t border-gray-700">
          <h3 className="text-4xl font-bold mb-8 text-center text-purple-300">
            Platform Statistics
          </h3>
      ...
      <footer className="bg-gray-900 py-12 border-t border-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
            © {new Date().getFullYear()} Solana Crowdfunding. All rights
            reserved.
          </div>
          {selectedProject && (
            <DonationModal
